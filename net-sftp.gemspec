...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'A pure Ruby implementation of the SFTP client protocol.'
  spec.description   = 'A pure Ruby implementation of the SFTP client protocol'
  ...
  if spec.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      spec.add_runtime_dependency('net-ssh', ['>= 5.0.0', '< 7.0.0'])
      spec.add_development_dependency('minitest', ['>= 5'])
      spec.add_development_dependency('mocha', ['>= 0'])
    else
      spec.add_dependency('minitest', ['>= 5'])
      spec.add_dependency('net-ssh', ['>= 5.0.0', '< 7.0.0'])
      spec.add_dependency('net-ssh', ['>= 5.0.0', '< 7.0.0'])
    end
  else
    spec.add_dependency('mocha', ['>= 0'])
    spec.add_dependency('net-ssh', ['>= 5.0.0', '< 7.0.0'])
    spec.add_dependency('net-ssh', ['>= 5.0.0', '< 7.0.0'])
    spec.add_dependency('test-unit', ['>= 0'])
=======
require_relative 'lib/net/sftp/version'
...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to? :specification_version then
    ...
    spec.add_dependency(%q<mocha>, [">= 0"])
>>>>>>> 632414f418f1adc2843da7521d42ad0f13037213
  end
end
