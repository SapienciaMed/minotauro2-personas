...
class TiposestadoscontratoControllerTest < ActionDispatch::IntegrationTest
  setup do
    @tiposestadoscontrato = tiposestadoscontrato(:one)
  end

  test "should get index" do
    get tiposestadoscontrato_index_url
  ...
  test "should create tiposestadoscontrato" do
    assert_difference('Tiposestadoscontrato.count') do
      post tiposestadoscontrato_index_url, params: { tiposestadoscontrato: { descripcion: @tiposestadoscontrato.descripcion, nombre: @tiposestadoscontrato.nombre, portafolio_id: @tiposestadoscontrato.portafolio_id, user_act: @tiposestadoscontrato.user_act, user_id: @tiposestadoscontrato.user_id } }
    end
  ...
  test "should destroy tiposestadoscontrato" do
    ...
    assert_redirected_to tiposestadoscontrato_index_url
  end
end
