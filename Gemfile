...
group :development do
  ...
  gem 'brakeman' # Gema para detectar vulnerabilidades
  gem 'bullet' # Gema N+1
  gem 'letter_opener' # Gema Envio de correos pruebas
  gem 'sendgrid-ruby' # Gema envio de correos desde sendgrid
end
